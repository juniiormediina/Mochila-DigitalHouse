//EL FINAL del progreso, en este caso modificamos
...
function aplicarDescuento(array) {
  //en la definición de la función puedo llamar como quiera a mis parámetros, de hecho si puedo poner nombres muy genéricos como en este caso, puedo pasar cualquier array y se puede reutilizar este fragmento para otros propósitos.
  let res = [];
